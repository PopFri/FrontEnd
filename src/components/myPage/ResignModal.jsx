...
export default function ResignModal(props) {
    return (
        <div className='profile-resignModal'>
            <div className='resignModal-container'>
                ...
                <div className='container-text'>
                    <p className='text-title'>회원 탈퇴</p>
                    <p className='text-detail'>
                        해당 동작은 되돌릴 수 없습니다.<br/>
                        회원 탈퇴를 진행하려면 아래 버튼을<br/>
                        클릭해주세요.
                    </p>
                </div>
                <div className='container-btn'>
                    ...
                    <div className='btn-delete'>
                        <p className='delete-text' onClick={() => props.handleDeleteAccount()}>삭제</p>
                    </div>
                </div>
            </div>
        </div>
